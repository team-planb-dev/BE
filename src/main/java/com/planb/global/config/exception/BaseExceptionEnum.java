...
public enum BaseExceptionEnum implements MessageCommInterface {
    ...
    SESSION_EXPIRED("BASE.EXCEPTION.SESSION_EXPIRED", "다른 기기에서 로그인하여 세션이 종료되었습니다."),
    LOGOUT_CREDENTIAL_NOT_FOUND("BASE.EXCEPTION.LOGOUT_CREDENTIAL_NOT_FOUND", "로그아웃할 인증 정보가 없습니다."),
    USER_NOT_FOUND("BASE.EXCEPTION.USER_NOT_FOUND", "해당 유저를 찾을 수 없습니다."),
    DUPLICATE_USERNAME("BASE.EXCEPTION.DUPLICATE_USERNAME", "이미 사용 중인 이메일 입니다."),
    DUPLICATE_NICKNAME("BASE.EXCEPTION.DUPLICATE_NICKNAME", "이미 사용 중인 닉네임 입니다."),
